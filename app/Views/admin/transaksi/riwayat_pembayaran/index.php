...
<script>
  ...
  function printNota(id) {
    window.open("<?= $_print_nota ?>/" + id, '_blank')
  }
    ...
    tabel = $("#datatable").DataTable({
      ...
      "columns": [{
        ...
        },
        {
          "render": function(data, type, row, meta) {
            var html = ""
            html += '<button type="button" class="btn btn-link text-info" onClick="printNota(' + row.transaksi_pembayaran_id + ')"><i class="fa fa-fw fa-print" aria-hidden="true" title="Print Nota"></i></button>'
            return html
          }
        },
      ],
