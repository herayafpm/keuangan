        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-child-indent nav-legacy" data-widget="treeview" role="menu" data-accordion="true">
            ...
            <?php if ($_admin->role_id == 1) : ?>
              ...
              <li class="nav-item">
                <a href="<?= base_url('admin/siswa') ?>" class="nav-link <?= (strpos($uri, "admin/siswa") !== false) ? "active" : "" ?>">
            ...
            <?php endif ?>
            <li class="nav-item">
              <a href="<?= base_url('admin/jenis_transaksi') ?>" class="nav-link <?= (strpos($uri, "admin/jenis_transaksi") !== false) ? "active" : "" ?>">
            ...
            <?php if ($_admin->role_id == 2) : ?>
              ...
              <li class="nav-item">
                <a href="<?= base_url('admin/transaksi') ?>" class="nav-link <?= (strpos($uri, "admin/transaksi") !== false) && (strpos($uri, "admin/transaksi/0") == false) && (strpos($uri, "admin/transaksi/1") == false) ? "active" : "" ?>">
              ...
              <?php if (sizeof($_transaksi_statuses) > 0) : ?>
                ...
                foreach ($_transaksi_statuses as $status) : ?>
                  ...
                  ?>
                  <li class="nav-item">
                    <a href='<?= base_url("admin/transaksi/{$no}") ?>' class="nav-link <?= (strpos($uri, "admin/transaksi/{$no}") !== false) && (strpos($uri, "admin/transaksi/{$no}/laporan") == false) ? "active" : "" ?>">
              ...
              <?php if (sizeof($_transaksi_statuses) > 0) : ?>
                ...
                foreach ($_transaksi_statuses as $status) : ?>
                  ...
                  ?>
                  <li class="nav-item">
                    <a href='<?= base_url("admin/transaksi/{$no}/laporan") ?>' class="nav-link <?= (strpos($uri, "admin/transaksi/{$no}/laporan") !== false) ? "active" : "" ?>">
                      <i class="nav-icon fas fa-<?= $icon ?>"></i>
                      <p class="text-capitalize">
                        Lap. Transaksi <?= $status ?>
                      </p>
                    </a>
                  </li>
                <?php
            ...
            <li class="nav-item">
              <a href="<?= base_url('admin/log') ?>" class="nav-link <?= (strpos($uri, "log") !== false && strpos($uri, "admin/admin/log") == false && strpos($uri, "admin/siswa/log") == false) ? "active" : "" ?>">
